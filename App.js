    ...
    return (
      ...
      >
        <TouchableOpacity
          ...
          onPress={() => {}}
        >
          <View style={{ left: 20, flexDirection: "row", marginTop: 5 }}>
            <Image
            ...
            >
              ...
              <Text color="#ac1b3a" weight="medium" size={10}>
                Bem vindo a Catar 2022
              </Text>
            </View>
          </View>
        </TouchableOpacity>
    ...
    return (
      <Tab.Navigator
        screenOptions={({ route }) => ({
          ...
          tabBarInactiveBackgroundColor: "#f0ece9",
          tabBarActiveBackgroundColor: "#f0ece9",
          tabBarStyle: {
